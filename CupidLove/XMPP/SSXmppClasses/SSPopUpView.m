    ...
    // set top images
    {
        ...
        // left image
        {
            ...
            //Set internal View
            {
                ...
                if (imageURL) {
                    [leftimage sd_setImageWithURL:imageURL placeholderImage:[UIImage imageNamed:@"EditProfile"]
                                        completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                                            
                                            if(image==nil)
                                                leftimage.image = [UIImage imageNamed:@"EditProfile"];
                                            else
        ...
        //Right image
        {
            ...
            
            {
                ...
                if (imageURL) {
                    [rightimage sd_setImageWithURL:imageURL placeholderImage:[UIImage imageNamed:@"EditProfile"]
                                         completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                                             
                                             if(image==nil)
                                                 rightimage.image = [UIImage imageNamed:@"EditProfile"];
                                             else
