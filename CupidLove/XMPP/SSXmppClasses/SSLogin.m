...
-(void)Auth
{
    NSError *error = nil;
     ...
     if ([[NSUserDefaults standardUserDefaults] objectForKey:@"XmppUserPassword"])
     {
          NSString *strPassword =[[NSUserDefaults standardUserDefaults] objectForKey:@"XmppUserPassword"];
          if (![[SSConnectionClasses shareInstance].xmppStream authenticateWithPassword:strPassword error:&error])
          {
