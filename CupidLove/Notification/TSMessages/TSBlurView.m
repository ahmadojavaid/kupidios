...
- (UIToolbar *)toolbar
{
    if (_toolbar == nil) {
        ...
        [_toolbar setBackgroundImage:[UIImage imageNamed:@"top-heading-bar64"] forToolbarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault]; // remove background set through the appearence proxy
#endif
