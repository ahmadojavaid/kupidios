    ...
    if ((self = [self init]))
    {
        ...
        else
        {
           ...
           // self.backgroundBlurView.blurTintColor = [UIColor colorWithHexString:current[@"backgroundColor"]];
            ...
            self.backgroundBlurView.blurTintColor = [UIColor colorWith8BitRed:0.0 green:185/255.0 blue:255/255.0 alpha:1.0];
...
- (id)initWithTitle:(NSString *)title
   ...
   inViewController:(UIViewController *)viewController
     ...
     buttonCallback:(void (^)())buttonCallback
         atPosition:(TSMessageNotificationPosition)position
canBeDismissedByUser:(BOOL)dismissingEnabled
       PushInfoDict:(NSMutableDictionary*)PushInfoDict
{
    NSDictionary *notificationDesign = [TSMessageView notificationDesign];
    ...
    if ((self = [self init]))
    {
        ...
        self.PushInfoDict = PushInfoDict;
        ...
        if (![TSMessage iOS7StyleEnabled])
        {
            ...
            UIImage *backgroundImage = [UIImage imageNamed:@"NotificationBackgroundSuccess"];
        ...
        if ([subtitle length])
        {
            ...
            [self.contentLabel setText:[[subtitle stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding] stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
            
            UIColor *contentTextColor = [UIColor colorWithHexString:[current valueForKey:@"contentTextColor"] alpha:1.0];
            
            contentTextColor = [UIColor whiteColor];
        ...
        {
            _iconImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 15, 45, 45)];
        ...
        _iconImageView.image = [UIImage imageNamed:@"Man.png"];
        _iconImageView.layer.cornerRadius = _iconImageView.frame.size.width/2;
        _iconImageView.clipsToBounds = YES;
        
        NSString *UserFBID = [PushInfoDict objectForKey:@"thirdparty_id"];
        
        NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://graph.facebook.com/%@/picture?width=100&height=100",UserFBID]];
        

        [_iconImageView sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"Man.png"] options:0 completed:^(UIImage *image , NSError *error , SDImageCacheType type , NSURL *imageURL)
         {
        ...
        if ([buttonTitle length])
        {
            ...
            buttonBackgroundImage = [UIImage imageNamed:@"cancel_push2"];
            ...
            self.button.frame = CGRectMake(screenWidth - padding - 40,                                          0.0,
                                           40,
                                           40);
...
- (CGFloat)updateHeightOfMessageView
{
    ...
    self.titleLabel.frame = CGRectMake(self.textSpaceLeft-5,
                                       padding,
    ...
    {
        self.contentLabel.frame = CGRectMake(self.textSpaceLeft-5,
                                             self.titleLabel.frame.origin.y + self.titleLabel.frame.size.height + 5.0,
                                             screenWidth - padding - self.textSpaceLeft - self.textSpaceRight+5,
                                             0.0);
