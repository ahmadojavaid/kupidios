...
- (void) addStatesHorizontally {
    ...
    for(NSInteger index = 1; index <= noOfPages; index++) {
        ...
        //TODO: Testing
        //btnState.contentMode = UIViewContentModeScaleAspectFit;
        btnState.frame = CGRectMake(btnState.frame.origin.x, btnState.frame.origin.y, 10, 10);
        //btnState.clipsToBounds = NO;
...
- (void) addStatesVertically {
    ...
    for(NSInteger index = 1; index <= noOfPages; index++) {
        ...
        y+=btnState.frame.size.height +  5;
    }
}
